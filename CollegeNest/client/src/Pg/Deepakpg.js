...
import Deepakpgreview from "../AccomodationReviews/Deepakpgreview";
...
const Deepakpg = () => {
  ...
  const getFetchData = async () => {
    const data = await axios.get("/dataofdeepakpg");
    ...
    <div>
      ...
      {data.map((e, i) => {
        return (
          <>
            <div>
              <div className="Deepakcontainer">
                <div className="Deepaksection">
                  <div className="Deepakdescription">
                    <h1>Deepak PG</h1>
                  </div>
                </div>

                <div className="Deepaksection">
                  <div className="Deepakcard">
                    <div className="Deepakcard-body">
                      <div className="Deepakimage-container">
                          <img src="/images/Deepak1.jpg" alt="PG Image" />
                          <img src="/images/Deepak3.jpg" alt="PG Image" />
                          <img src="/images/Deepak2.jpg" alt="PG Image" />
                      </div>
                      
                      <div className="Deepakroom-description">
                        <p>
                          The {e.accomodation} is a 4-storey building located
                        ...
                        <ul>
                          <li>
                            Single room with 2 beds, 1 Godrej Almirah, and an
                            attached washroom.
                          </li>
                      ...
                      <div className="Deepakfacilities">
                        <h3>Facilities:</h3>
                        <ul>
                          <li>Fans</li>
                          ...
                          <li>Solar water system available</li>
                          <li>Washing machine per floor</li>
                          <li>
                            Shop for stationary and food items available in PG
                          </li>
                          <li>
                            Generator facility, especially during exam time
                          </li>
                        </ul>
                        <br />
                        <h3>Rules: </h3>
                ...
                <div className="Deepakfooter">
                  <p>
                    <h3>Contact Details</h3>
                    Owner's Name: Mr.Deepak Chauhan
                    <br />
                    Owner's Number: 9129402100(Also available on WhatsApp)
                    <br />
                  </p>
                  <p style={{ textAlign: "center" }}>
                    &copy; 2023 Deepak PG. All rights reserved.
                  </p>
                </div>
              </div>
            </div>
